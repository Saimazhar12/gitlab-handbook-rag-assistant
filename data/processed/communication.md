...
5. **Always Adhere to our Anti-Harassment Policy and GitLab Code of Business Conduct and Ethics.** Everyone should be comfortable in their work environment.
...
Escalate to management if you are not getting the support you need. Remember that everyone is a manager of one and they might have to complete their own assignments and inform the reporting lines.
...
2. **Protect confidential information**: Be aware of Data Classification Standards for the data and AI tooling you’re using. Use only approved internal tools for sensitive content.
3. **Maintain authenticity**: Ensure your communications reflect genuine human judgment and align with our values. This is especially important in customer interactions and when providing feedback.
...
9. To thank someone who is not a team member, nominate them as a Notable Contributor.
...
5. Not every solution will solve the problem at hand. Keep discussions focused by **defining the problem first** and **explaining your rationale** behind the Minimal Valuable Change (MVC) proposed in the MR.
...
7. Write down your questions in the agenda before vocalizing. Always ask people to vocalize their questions to provide the most detailed context and for audio-only playbacks.
8. Use discretion in taking notes if sensitive topics are being discussed. For example, do not takes notes on not-public information if the agenda may be available to an audience who should not be privy to this information.
...
10. At the end of the meeting, clearly capture key takeaways, next steps, and DRIs.
...
7. For meetings that are scheduled with Zoom:
   * After reviewing our Zoom handbook page, if you have additional questions, please contact us via the Compass app in Slack (type “Compass” in the top search bar to find it) or [it-help@gitlab.com](mailto:it-help@gitlab.com).
...
2. Read our Markdown Style Guide for more information when using Markdown.
3. Do not use ALL CAPS because it feels like shouting. However, there is the `#all-caps` Slack channel for your good-natured shouting needs.
...
6. When mentioning currency amounts that team members may need to convert to their local currency (e.g. benefits, expenses, or bonuses), link those amounts to our Exchange Rates section (e.g. 500 USD).
...
16. Use inclusive and gender-neutral language in all writing.
...
24. If acronyms are used, expand them at least once in the conversation or document and define them in the document using Kramdown abbreviation syntax. Alternatively, link to the definition.
25. If you don’t know the meaning of an acronym, ask. It’s always ok to speak up.
...
5. GitLab operates on a Fiscal Year offset from the calendar year. When referring to a fiscal year or quarter, please use the following abbreviations:
...
6. For time formatting guidelines, refer to the GitLab Content Style Guide.
...
4. In both public and private channels, threads are valuable for keeping conversations together. If you want to respond to a question or comment in a channel, please start a thread instead of responding below them in the channel. This helps to keep the discussion in one place where it is easy to follow, and reduces noise as each message in a thread does not result in an unread message for everyone in the channel.
