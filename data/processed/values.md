...
![Collaboration](#collaboration) ![Results](#results) ![Efficiency](#efficiency) ![Diversity, Inclusion & Belonging](#diversity-inclusion) ![Iteration](#iteration) ![Transparency](#transparency)
...
3. **Our existing scope**. For example, when customers asked for better integrations and complained about integration costs and effort, we responded by expanding our scope to create a single application for the DevOps lifecycle.
