...
source_url: "https://handbook.gitlab.com/handbook/company/culture/inclusion/"
scraped_at: "2026-09-05"
doc_id: "diversity-inclusion-belonging"
---
...
Diversity complements our other [values](https://handbook.gitlab.com/handbook/values/), specifically Collaboration, Efficiency and Results.
...
We believe in empowering team members to get their work done efficiently and collaboratively by establishing clear [DRIs](https://handbook.gitlab.com/handbook/people-group/directly-responsible-individuals/) for all our work. [DRIs do not owe anyone an explanation for their decisions](https://handbook.gitlab.com/handbook/people-group/directly-responsible-individuals/#empowering-dris), but DRIs can still acknowledge input by closing an issue and marking it `Won't Do` or commenting on an issue acknowledging that they have read all the comments.

All team members don’t have to agree on the best course of action\* we can [disagree, commit, and disagree](https://handbook.gitlab.com/handbook/values/#disagree-and-commit)- but everyone can contribute and it is on the DRI to acknowledge those.
Some other ways we actively cultivate a sense of Belonging at GitLab include creating and cultivating allies, welcoming family members in the background of a call, and sharing [negative feedback in 1-1 settings](https://handbook.gitlab.com/handbook/values/#negative-feedback-is-1-1).
...
* Women - Globally
* Women in [Management](https://handbook.gitlab.com/handbook/company/structure/#organizational-chart) - Globally
* Women in [Senior Leadership](https://handbook.gitlab.com/handbook/company/structure/#organizational-chart) - Globally
* Black/African American - United States
* Black/African American in [Management](https://handbook.gitlab.com/handbook/company/structure/#organizational-chart) - United States
* Black/African American in [Senior Leadership](https://handbook.gitlab.com/handbook/company/structure/#organizational-chart) - United States
* Hispanic/Latino - United States
* Hispanic/Latino in [Management](https://handbook.gitlab.com/handbook/company/structure/#organizational-chart) - United States
* Hispanic/Latino in [Senior Leadership](https://handbook.gitlab.com/handbook/company/structure/#organizational-chart) - United States
* Indigenous Peoples/Alaska Native - United States
* Indigenous Peoples/Alaska Native in [Management](https://handbook.gitlab.com/handbook/company/structure/#organizational-chart) - United States
* Indigenous Peoples/Alaska Native in [Senior Leadership](https://handbook.gitlab.com/handbook/company/structure/#organizational-chart) - United States
* Hawaiian/Pacific Islander - United States
* Hawaiian/Pacific Islander in [Management](https://handbook.gitlab.com/handbook/company/structure/#organizational-chart) - United States
* Hawaiian/Pacific Islander in [Senior Leadership](https://handbook.gitlab.com/handbook/company/structure/#organizational-chart) - United States
...
We aim to align [our values](https://handbook.gitlab.com/handbook/values/) to be reflective of our company wide commitment to fostering a diverse and inclusive environment.
...
Candidates are not limited by geography and we [champion this approach](https://handbook.gitlab.com/handbook/company/culture/all-remote/), to the extent that it’s possible, for all companies!
...
* All-remote means that you [will not sacrifice career advancement](https://handbook.gitlab.com/handbook/people-group/learning-and-development/) by working outside of the office, as even GitLab executives are fully remote.
...
* GitLab’s approach to [Spending Company Money](https://handbook.gitlab.com/handbook/finance/spending-company-money/) enables all team members to create a work environment uniquely tailored for them.
...
Learn more about GitLab’s [all-remote culture](https://handbook.gitlab.com/handbook/company/culture/all-remote/).

## GitLab team member data

Please see our [identity data](https://handbook.gitlab.com/handbook/company/culture/inclusion/identity-data/).

## What we are doing with Diversity, Inclusion & Belonging

### Talent Acquisition initiatives

[This page provides an overview of our Diversity, Inclusion & Belonging Talent Acquisition initiatives](https://handbook.gitlab.com/handbook/company/culture/inclusion/).

### Engineering Initiatives

[This page provides an overview of our Diversity, Inclusion & Belonging Engineering initiatives](https://handbook.gitlab.com/handbook/company/culture/inclusion/engineering-initiatives/)
...
We list our [Pregnancy & Maternity Care](https://handbook.gitlab.com/handbook/total-rewards/benefits/general-and-entity-benefits/inc-benefits-us/) publicly so people don’t have to ask for them during interviews. In addition GitLab offers an Employee Assistance Program to all team members via [Modern Health](https://handbook.gitlab.com/handbook/total-rewards/benefits/modern-health/), a one-stop shop for all tools related to mental well-being and self-improvement.

### Inclusive language

In our [GitLab Values](https://handbook.gitlab.com/handbook/values/#inclusive-language--pronouns) we list: ‘Use inclusive language. For example, prefer “Hi everybody” or “Hi people” to “Hi guys”.

### TMRGs - Team Member Resource Groups

We have created several TMRGs and welcome interest in creating new ones. Would you like to sign up for an Team Member Resource Group, start an TMRG, or just learn more? See our [TMRG Guide](https://handbook.gitlab.com/handbook/company/culture/inclusion/tmrg-tmag/).

### Military veterans and spouses

GitLab welcomes military veterans from around the world, as well as military spouses, to learn more about [life at GitLab](https://handbook.gitlab.com/handbook/company/culture/#life-at-gitlab) and to apply for [vacancies](https://about.gitlab.com/jobs/). We recognize the values gained from military experience, and we foster an [inclusive atmosphere](https://handbook.gitlab.com/handbook/company/culture/all-remote/building-culture/) to thrive in when returning to civilian life.

Our [all-remote culture](https://handbook.gitlab.com/handbook/company/culture/all-remote/) provides an ideal work environment for military veterans and spouses. By empowering team members to live and work where they are most comfortable, veterans and spouses can work in a safe, nurturing environment that they [choose and design](https://handbook.gitlab.com/handbook/company/culture/all-remote/workspace/).

We encourage military veterans and spouses to [read testimonials](https://handbook.gitlab.com/handbook/company/culture/all-remote/) from GitLab team members to understand the benefits of all-remote when [joining the workforce](https://handbook.gitlab.com/handbook/company/culture/all-remote/getting-started/) following military service. We are committed to our [Military Leave](https://handbook.gitlab.com/handbook/people-policies/leave-of-absence/#military-leave) policy.

*GitLab is actively [iterating](https://handbook.gitlab.com/handbook/values/#iteration) within Diversity, Inclusion & Belonging and Talent Acquisition to ensure that additional underrepresented groups are pursued, embraced, and positioned for success.*
...
If you are unsure how to answer, please review our [Individual with Disabilities Policy](https://handbook.gitlab.com/handbook/people-policies/inc-usa/#individuals-with-disabilities-policy).

At GitLab, we are proud to make reasonable accommodations to the known disability of a team member. Please review the [reasonable accommodation](https://handbook.gitlab.com/handbook/people-policies/inc-usa/#reasonable-accommodation) handbook section if you need a reasonable accommodation due to your disability. Find more information on GitLab Inc’s [Individuals with Disabilities](https://handbook.gitlab.com/handbook/people-policies/inc-usa/#individuals-with-disabilities-policy) policy.
...
2. Assign the issue to a DIB Team Member and a L&D team member - the assignees must not be someone who participated in creating or curating the training
3. The assignees will go through the content of the training and complete the QA process as outlined in the issue.
4. The content creator and assignees will use the issue to collaborate on and document improvements made to the content that align with quality check list above
5. When all 3 participants agree that the course has met our inclusion and learning standards, close the issue and proceed with adding the materials or course to GitLab Learn
...
* [Leadership](https://handbook.gitlab.com/handbook/company/structure/#organizational-chart) is defined as director and above.
* [Geographically](https://handbook.gitlab.com/handbook/company/culture/inclusion/identity-data/) is defined as those countries we use in our identity data.
...
guide to understanding how bias can show up in performance, promotion, and feedback at GitLab—and how to navigate it fairly.
...
##### [Neurodivergence and NeuroInclusion at GitLab](https://handbook.gitlab.com/handbook/company/culture/inclusion/neurodiversity-and-neuroinclusion/)

Learn about GitLab's approach to neuroinclusion — supporting cognitive diversity through inclusive design, learning, and community.
...
##### [TMxG – Team Member Resource and Advocacy Group Guide](https://handbook.gitlab.com/handbook/company/culture/inclusion/tmrg-tmag/)

What Team Member Resource Groups (TMRGs) and Team Member Advocacy Groups (TMAGs) are at GitLab, how they work, and how to get involved.

Last modified April 30, 2026: [Remove team shortcode and replace urls (`02172f8f`)](https://gitlab.com/gitlab-com/content-sites/handbook/commit/02172f8f)

[View page source](https://gitlab.com/gitlab-com/content-sites/handbook/blob/main/content/handbook/company/culture/inclusion/_index.md)
-
[Edit this page](https://gitlab.com/-/ide/project/gitlab-com/content-sites/handbook/edit/main/-/content/handbook/company/culture/inclusion/_index.md)
-
